export default {
    ...
    ["POST /api/users/createuser"] : {
        ...
        queries: [],
        exampleRequest: {"post": "{{baseUrl}}/api/users/createuser",
    ...
    ["PATCH /api/profiles/:id"] : {
        ...
        description: "Serves a user profile record matching the given ID.",
        queries: [],
        exampleRequest: {patch: "patch {{baseUrl}}/api/profiles/64d193c00f06b557f95793e6",
        ContentType: "application/json",
            body:{
                profile: {
                    _id: "64d193c00f06b557f95793e6",
    ...
    ["PATCH /api/events/:id"] : {
        ...
        queries: [],
        exampleRequest: {patch: "patch {{baseUrl}}/api/events/64d193c00f06b557f95793fe",
        ContentType: "application/json",
            body:{
                event: {
                  user_id: "64d193c00f06b557f95793d8",
    ...
    ["POST /api/events/"] : {
        ...
        queries: [],
        exampleRequest: {"post": "{{baseUrl}}/api/events/",
            ContentType: "application/json",
            body:{
                "event": {
